# cryo7: SDC in ns (cryo liberty time_unit=1ns); ASAP7 original is 1000ps.
...
set_clock_latency 0.161775 [get_clocks $clk_name]
set_clock_latency 0.161775 [get_clocks $clk_io_name]
